        ...
        <div className="space-y-8">
          ...
          <Card className="border-primary/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                <strong className="text-foreground">Pyramid Compass</strong> est un <strong className="text-foreground">outil d'analyse et de simulation</strong> conçu pour aider à comprendre les systèmes socio-économiques de différents pays et explorer des trajectoires de vie hypothétiques.
              </p>
