...
import { GameResources, GameAction, GAME_ACTIONS, ResourceType, RESOURCE_INFO } from '@/lib/game-data';
...
export default function ActionPanel({
  ...
  const majorActions = GAME_ACTIONS.filter(a => a.type === 'major');
          ...
          {selectedAction && (
            <div className="space-y-4 mt-4">
              ...
              <div className="glass-card rounded-lg p-4 space-y-3">
                ...
                {selectedAction.riskChance && selectedAction.riskChance > 0 && (
