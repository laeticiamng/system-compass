      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="flex flex-wrap gap-4 mt-12 justify-center">
          ...
          <Button variant="outline" className="gap-2" onClick={() => {
            const shareText = `🎮 J'ai joué à Compass et obtenu un score de ${rankedResults[0]?.lifeScore.total || 0}! Verdict: ${t(`gameEnd.verdicts.${rankedResults[0]?.lifeScore.verdict}.label`)}`;
            if (navigator.share) {
