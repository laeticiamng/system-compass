    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-4 max-w-md">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-muted-foreground">{t('pyramidQuiz.multiplayer.setup', 'Configuration de la partie')}</p>
        </div>

        <div className="glass-card rounded-xl p-8 animate-scale-in">
          <h3 className="font-semibold mb-6">{t('pyramidQuiz.multiplayer.selectPlayers', 'Nombre de joueurs')}</h3>
