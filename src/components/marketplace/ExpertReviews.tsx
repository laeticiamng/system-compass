...
const MOCK_REVIEWS: Review[] = [
  {
    ...
    content: 'Maître Laurent m\'a accompagné dans ma transition vers la Suisse. Sa connaissance des conventions fiscales franco-suisses est impressionnante. Tout a été géré de manière professionnelle et transparente.',
    verified: true,
    helpful: 24,
    createdAt: new Date('2025-11-15'),
    expertResponse: 'Merci Jean-Pierre pour votre confiance. Ce fut un plaisir de vous accompagner dans ce projet.',
